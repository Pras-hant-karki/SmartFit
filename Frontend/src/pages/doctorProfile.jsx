    ...
    return (
      <div className="min-h-[60vh] bg-gray-50 flex items-center justify-center p-4">
        <Alert variant="destructive" className="max-w-md">
          ...
          <AlertDescription>{formatErrorMessage(error, "Failed to load doctor profile")}</AlertDescription>
        </Alert>
      </div>
    );
  }
    ...
    return (
      <div className="min-h-[60vh] bg-gray-50 flex items-center justify-center p-4">
        <div className="text-center">
          ...
          <Button onClick={() => navigate("/doctors")} className="mt-4 bg-white text-black border border-black hover:bg-gray-50">
            Browse Doctors
          </Button>
        </div>
      </div>
          ...
          <CardHeader className="bg-gradient-to-r from-blue-600 to-blue-700 text-white pb-8 pt-8">
            <div className="flex flex-col md:flex-row gap-6 items-center md:items-start">
              ...
              <div className="relative">
                ...
                <Badge className="absolute bottom-0 right-0 bg-[#02B833] hover:bg-[#02B833]">
                  Available
                </Badge>
              </div>
          ...
          <CardContent className="p-8">
            ...
            <div className="mt-8 pt-8 border-t">
              <Button
                ...
                className="w-full md:w-auto gap-2 bg-[#02B833] hover:bg-[#029E2C] text-white shadow-lg shadow-[#02B833]/25"
              >
