    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50 py-12">
      ...
      <div className="container mx-auto px-4 lg:px-8 max-w-6xl">
        ...
        <Button
          variant="ghost"
          onClick={() => navigate(-1)}
          className="mb-6 gap-2 bg-white text-black border border-black hover:bg-gray-50"
        >
              ...
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                        ...
                        <div className="grid grid-cols-3 gap-3">
                          {slotTimes.map((slot) => (
                            <Button
                              ...
                              className={`h-12 ${
                                selectedTime === slot
                                  ? "bg-[#02B833] hover:bg-[#029E2C] text-white ring-2 ring-[#02B833] ring-offset-2"
                ...
                {error && (
                  <Alert variant="destructive">
                    <AlertCircle className="h-4 w-4" />
                    <AlertDescription>
                      {formatErrorMessage(error, "Unable to book appointment")}
                    </AlertDescription>
                  </Alert>
                )}
                ...
                <Button
                  ...
                  className="w-full h-12 text-base font-medium bg-[#02B833] hover:bg-[#029E2C] text-white disabled:opacity-60"
                  size="lg"
                >
                  {loading ? (
                    <>
