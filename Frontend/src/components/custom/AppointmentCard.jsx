...
const AppointmentCard = ({ appointment }) => {
  ...
  const doctorName = doctordetails?.doctorname || "Doctor unavailable";
  const department = doctordetails?.department || "Department unavailable";
        ...
        <div className="flex items-start justify-between">
          <div className="flex-1">
            <h3 className="text-lg font-bold text-gray-900 group-hover:text-blue-600 transition-colors mb-1">
              {doctorName === "Doctor unavailable" ? doctorName : `Dr. ${doctorName}`}
            </h3>
      ...
      <CardContent className="flex-1 pt-4 pb-4 space-y-3">
        ...
        <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg">
          ...
          <div>
            ...
            <p className="text-sm font-semibold text-gray-900">{appointmenttime || "Time unavailable"}</p>
          </div>
        </div>
      </CardContent>
